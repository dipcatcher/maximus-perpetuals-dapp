  ...
  def get_values(self):
    ...
    if self.address is None:
      try:
        ...
        self.your_maxi_balance= anvil.server.call('maxi_balance',self.address, get_open_form().pool_address)
      ...
      self.your_maxi_balance= anvil.server.call('maxi_balance',self.address, contract_address)
